...
# Os objetos podem viver separadamente, mas pode se tratar de uma relação onde um objeto precisa 
# de outro para fazer determinada tarefa (existem controvérsias sobre as definições de agregação).
