...
#     ...
#     type('Name', (Bases,), __dict__)
# Foo = type('Foo', (object,), {}) # criando a classe (um novo tipo da classe object)
# f = Foo()
...
class  Meta(type): # a classe Meta herda de type -> é uma metaclass
    def __new__(mcs, name, bases, dct):
        print('METACLASS NEW ***')
        # esse método new cria a classe, que é uma instância da MetaClass
        cls = super().__new__(mcs, name, bases, dct) # está mandando todos esses param pro new pq é o new do type
        # cls.atributo = 1234
    ...
    def __call__(cls, *args, **kwargs):
        ...
        print(instancia.__dict__, 'aaaaaa')
